  ...
  return (
    <div className="glass-panel rounded-2xl p-6 border border-slate-800 shadow-xl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between pb-5 border-b border-slate-800 gap-4">
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <button
            ...
            className="px-2.5 py-1 text-xs font-medium bg-emerald-950/80 text-emerald-400 border border-emerald-800/80 rounded-lg hover:bg-emerald-900/60 transition-colors"
          >
            Low Risk ($25)
          </button>
          <button
            ...
            className="px-2.5 py-1 text-xs font-medium bg-amber-950/80 text-amber-400 border border-amber-800/80 rounded-lg hover:bg-amber-900/60 transition-colors"
          >
            Medium OTP ($4.5k)
          </button>
          <button
            ...
            className="px-2.5 py-1 text-xs font-medium bg-rose-950/80 text-rose-400 border border-rose-800/80 rounded-lg hover:bg-rose-900/60 transition-colors"
          >
            High Risk ($18.5k)
          </button>
        </div>
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-8 pr-3 py-2 bg-slate-900 border rounded-xl text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all ${
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-sm text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all"
              >
        ...
        <div className="pt-2">
          <div className="flex items-center justify-between cursor-pointer py-2 border-t border-slate-800" onClick={() => setShowOptional(!showOptional)}>
            <div className="flex items-center space-x-2">
          ...
          {showOptional && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-3 bg-slate-900/40 p-4 rounded-xl border border-slate-800/80">
              <div>
                <label className="block text-[11px] font-medium text-slate-400 mb-1">Device ID</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-[11px] font-medium text-slate-400 mb-1">IP Address</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-[11px] font-medium text-slate-400 mb-1">Geo Location</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-[11px] font-medium text-slate-400 mb-1">Sender Account Balance ($)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-[11px] font-medium text-slate-400 mb-1">Merchant / Institution Name</label>
                <input
                  type="text"
              ...
              <div className="md:col-span-2">
                <label className="block text-[11px] font-medium text-slate-400 mb-1">Transaction Description</label>
                <input
                  type="text"
